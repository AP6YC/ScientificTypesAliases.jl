...
# Real-numbered aliases
const ContinuousArray{T<:Continuous, N} = AbstractArray{T, N}
const ContinuousVector{T<:Continuous} = ContinuousArray{T, 1}
const ContinuousMatrix{T<:Continuous} = ContinuousArray{T, 2}

# Integered aliases
const CountArray{T<:Count, N} = AbstractArray{T, N}
const CountVector{T<:Count} = AbstractArray{T, 1}
const CountMatrix{T<:Count} = AbstractArray{T, 2}
